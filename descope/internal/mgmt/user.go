...
func (u *user) UpdateEmail(ctx context.Context, loginIDOrUserID, email string, isVerified bool, onConflictFail bool) (*descope.UserResponse, error) {
	if loginIDOrUserID == "" {
		return nil, utils.NewInvalidArgumentError("loginIDOrUserID")
	}
	req := map[string]any{"loginId": loginIDOrUserID, "email": email, "verified": isVerified, "onConflictFail": onConflictFail}
...
func (u *user) UpdatePhone(ctx context.Context, loginIDOrUserID, phone string, isVerified bool, onConflictFail bool) (*descope.UserResponse, error) {
	if loginIDOrUserID == "" {
		return nil, utils.NewInvalidArgumentError("loginIDOrUserID")
	}
	req := map[string]any{"loginId": loginIDOrUserID, "phone": phone, "verified": isVerified, "onConflictFail": onConflictFail}
