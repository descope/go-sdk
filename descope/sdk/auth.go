...
type EnchantedLink interface {
	...
	// the jwt would be returned on the getSession function at the end of the flow rather that on the verify.
	// returns an error upon failure.
	SignInWithPhone(ctx context.Context, phone, URI string, r *http.Request, loginOptions *descope.LoginOptions) (*descope.EnchantedLinkResponse, error)
	...
	// optional to add user metadata for farther user details such as name and more.
	// returns an error upon failure.
	SignUpWithPhone(ctx context.Context, phone, URI string, user *descope.User, signUpOptions *descope.SignUpOptions) (*descope.EnchantedLinkResponse, error)
	...
	// optional to add user metadata for farther user details such as name and more.
	// returns an error upon failure.
	SignUpOrInWithPhone(ctx context.Context, phone string, URI string, signUpOptions *descope.SignUpOptions) (*descope.EnchantedLinkResponse, error)
