...
type Authentication interface {
	...
	// if crossDevice is false, it will return an empty string, and VerifyMagicLink will return an authenticated session.
	// returns an error upon failure.
	SignInMagicLink(method DeliveryMethod, identifier, URI string, crossDevice bool) (pendingRef string, err error)
	...
	// if crossDevice is false, it will return an empty string, and VerifyMagicLink will return an authenticated session.
	// returns an error upon failure.
	SignUpMagicLink(method DeliveryMethod, identifier, URI string, user *User, crossDevice bool) (pendingRef string, err error)
