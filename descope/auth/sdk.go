...
type MagicLink interface {
	...
	GetSession(pendingRef string, r *http.Request, loginOptions *LoginOptions, w http.ResponseWriter) (*AuthenticationInfo, error)
	...
	Verify(token string, r *http.Request, loginOptions *LoginOptions, w http.ResponseWriter) (*AuthenticationInfo, error)
...
type OTP interface {
	...
	VerifyCode(method DeliveryMethod, identifier string, code string, r *http.Request, loginOptions *LoginOptions, w http.ResponseWriter) (*AuthenticationInfo, error)
...
type OAuth interface {
	...
	ExchangeToken(code string, r *http.Request, loginOptions *LoginOptions, w http.ResponseWriter) (*AuthenticationInfo, error)
}
...
type WebAuthn interface {
	...
	// Use the ResponseWriter (optional) to apply the cookies to the response automatically.
	SignUpFinish(finishRequest *WebAuthnFinishRequest, r *http.Request, loginOptions *LoginOptions, w http.ResponseWriter) (*AuthenticationInfo, error)
	...
	// by the credentials navigator.
	// Use the ResponseWriter (optional) to apply the cookies to the response automatically.
	SignInFinish(finishRequest *WebAuthnFinishRequest, r *http.Request, loginOptions *LoginOptions, w http.ResponseWriter) (*AuthenticationInfo, error)
